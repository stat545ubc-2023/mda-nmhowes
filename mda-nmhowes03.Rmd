...
#First I wanted to "Plot the distribution of a numeric variable" for this task I want to look at diameter 
...
#I also want to look at trees in my own neighbourhood to see what tree's I could look at during an everyday walk (Filter observations in your data according to your own criteria)
```{r}
...
#I wanted to additionally look at the relationship between 2 variables in a plot being the diameter and species in Kitsilano 
```{r}
vancouver_trees %>%
